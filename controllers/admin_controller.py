...
@bp.route("/admin/audit-logs", endpoint="admin_audit_logs")
@admin_required_decorator
...
@bp.route("/admin/recruiters", endpoint="admin_recruiters")
@admin_required_decorator
...
@bp.route("/admin/recruiters/<int:user_id>/status", methods=["POST"], endpoint="admin_update_recruiter_status")
@admin_required_decorator
...
@bp.route("/admin/opportunities", endpoint="admin_opportunities")
@admin_required_decorator
...
@bp.route("/admin/opportunities/create", methods=["GET", "POST"], endpoint="admin_create_opportunity")
@admin_required_decorator
...
@bp.route("/admin/opportunities/<int:opportunity_id>/edit", methods=["GET", "POST"], endpoint="admin_edit_opportunity")
@admin_required_decorator
...
@bp.route("/admin/opportunities/<int:opportunity_id>/delete", methods=["POST"], endpoint="admin_delete_opportunity")
@admin_required_decorator
