...
@bp.route("/opportunities", endpoint="opportunities")
def opportunities():
...
@bp.route("/opportunities/<int:opportunity_id>", endpoint="opportunity_detail")
...
@bp.route("/opportunities/<int:opportunity_id>/bookmark", methods=["POST"], endpoint="bookmark_opportunity")
...
@bp.route("/bookmarks/<int:opportunity_id>/remove", methods=["POST"], endpoint="remove_bookmark")
@jobseeker_required_decorator
...
@bp.route("/bookmarks", endpoint="bookmarks")
@jobseeker_required_decorator
def bookmarks():
    try:
